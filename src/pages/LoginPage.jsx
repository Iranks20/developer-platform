...
const LoginPage = () => {
  ...
  const handleGoogleSignIn = async (googleResponse) => {
    ...
    try {
      const response = await authApi.googleSignIn(googleResponse.credential)
      login(response.user)
      navigate('/dashboard')
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-primary-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          >
            <h1 className="text-5xl font-bold mb-6 font-heading text-white">Welcome back</h1>
            <p className="text-xl text-primary-100 mb-8 leading-relaxed">
              Sign in to your developer account and continue building amazing applications.
            </p>
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-lg font-medium">Access your applications</span>
              </div>
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-lg font-medium">Manage API keys</span>
              </div>
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-lg font-medium">View analytics & usage</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-10">
            <div className="mx-auto h-16 w-16 gradient-primary rounded-card flex items-center justify-center mb-6 shadow-lg">
              <svg className="h-10 w-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
              </svg>
            </div>
            <h2 className="text-4xl font-bold text-gray-800 font-heading mb-3">Sign in to your account</h2>
